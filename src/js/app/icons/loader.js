const Loader = ( { width = 100 } ) => (
	<svg className="loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width={ width }>
		<rect fill="none" stroke="#C4C4C4" strokeWidth="4" x="25" y="25" width="50" height="50">
		...
		<rect x="27" y="27" fill="#C4C4C4" width="46" height="14.132">
